...
const socialLinks: Social[] = [
  ...
  { imgsrc: '/images/Footer/twitter.svg', href: "https://x.com/SolninoRich/" },
  ...
  return (
    <div className=" relative">
        ...
        <div className="mt-24 grid grid-cols-1 gap-y-10 gap-x-16 sm:grid-cols-2 lg:grid-cols-12 xl:gap-x-8">
          ...
          <div className='col-span-6'>
            <img
              ...
              src={'/images/Logo/Solnino-logo01.svg'}
              alt="Crypto-Logo"
            />
          ...
          <div className="col-span-4">
            <h3 className="text-white text-xl font-medium mb-9">If you need - Contact Us</h3>
            ...
            <h4 className="text-offwhite text-sm font-normal mb-6 flex gap-2"><Image src={'/images/Footer/email.svg'} alt="email-icon" width={20} height={20} />solninorich@gmail.com</h4>
      ...
      <div className='py-8 px-4 border-t border-t-lightblue'>
        <h3 className='text-center text-offwhite'>@2024 - All Rights Reserved by <Link href="https://solnino.com/" target="_blank"> solnino.com</Link></h3>
      </div>
